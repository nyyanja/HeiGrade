...
class TeacherIT extends FacadeIT {
  ...
  private final String teacherEmail = "teacher.it@heigrade.com";
  private final String studentEmail = "teacher.student@heigrade.com";
  ...
  @Test
  void shouldRejectStudentFromGettingTeachers() {
  ...
  void shouldRejectUnauthenticatedRequest() {
    ResponseEntity<String> response =
        restTemplate.getForEntity("http://localhost:" + port + "/teachers", String.class);
