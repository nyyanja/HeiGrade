...
class PromotionIT extends FacadeIT {
  ...
  private final String adminEmail = "promotion.admin@heigrade.com";
  private final String studentEmail = "promotion.student@heigrade.com";
  ...
  void shouldRejectUnauthenticatedRequest() {
    ResponseEntity<String> response =
        restTemplate.getForEntity("http://localhost:" + port + "/promotions", String.class);

    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
  }

  @Test
  void shouldAllowAdminToGetPromotions() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            "http://localhost:" + port + "/promotions", HttpMethod.GET, request, String.class);

    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
  }

  @Test
  void shouldRejectStudentFromCreatingPromotion() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            "http://localhost:" + port + "/promotions", HttpMethod.POST, request, String.class);
