...
class CourseServiceTest {
    ...
    void should_throw_when_teacher_not_found_in_filter() {
        ...
        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByTeacher(teacherId));
    }
    ...
    void should_find_courses_by_speciality() {
        ...
        when(specialityRepository.existsById(specialityId)).thenReturn(true);
        when(courseRepository.findBySpecialityId(specialityId))
    ...
    void should_throw_when_credit_is_invalid() {
        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByCredit(0));

        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByCredit(null));
    }
    ...
    void should_throw_when_group_not_found() {
        ...
        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByGroup(groupId));
    }
    ...
    void should_find_courses_by_title() {
        ...
        when(courseRepository.findByTitleContainingIgnoreCase("Program"))
                .thenReturn(List.of(course));
    ...
    void should_throw_when_level_is_invalid() {
        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByLevel(0));

        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByLevel(4));

        assertThrows(
                ResponseStatusException.class,
                () -> courseService.findByLevel(null));
    }
}