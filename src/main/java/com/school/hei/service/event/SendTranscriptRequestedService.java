...
@AllArgsConstructor
@Slf4j
public class SendTranscriptRequestedService
        implements Consumer<SendTranscriptRequested> {
    ...
    public void accept(SendTranscriptRequested event) {
        ...
        Transcript transcript =
                transcriptService.getStudentTranscriptForSystem(studentId, level);
        ...
        try {
            ...
            log.info(
                    "Transcript sent successfully to student {} for level {}",
                    studentId,
                    level);
