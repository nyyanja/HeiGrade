  ...
  public void accept(Group group) {
    if (group == null) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "the parameter is null or empty it cannot be saved");
    }
    if (group.getName() == null || group.getName().isBlank()) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "group name cannot be null or empty it is not allowed");
    }
    ...
    if (group.getSpeciality() == null || group.getSpeciality().getId() == null) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "the speciality cannot be null or empty it is not allowed");
    }
